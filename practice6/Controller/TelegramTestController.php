...
class TelegramTestController extends Controller {
    ...
    public function index() {
        ...
        $data = json_decode('{"update_id":928317500, "message":{"message_id":7,"from":{"id":830545191,"is_bot":false,"first_name":"Elena","last_name":"Nikulina","language_code":"ru"},"chat":{"id":830545191,"first_name":"Elena","last_name":"Nikulina","type":"private"},"date":1730653785,"text":"/start","entities":[{"offset":0,"length":6,"type":"bot_command"}]}}{"update_id":928317501, "message":{"message_id":8,"from":{"id":830545191,"is_bot":false,"first_name":"Elena","last_name":"Nikulina","language_code":"ru"},"chat":{"id":830545191,"first_name":"Elena","last_name":"Nikulina","type":"private"},"date":1730656165,"text":"/start","entities":[{"offset":0,"length":6,"type":"bot_command"}]}}', true);
        $chatId = 0;
        $text = "";
        $input = null;
        $from = "";
        // $data = json_decode('{"a":1,"b":2,"c":3,"d":4,"e":5}', true);
        $jsonString = '{"update_id":928317525,"message":{"message_id":41,"from":{"id":830545191,"is_bot":false,"first_name":"Elena","last_name":"Nikulina","language_code":"ru"},"chat":{"id":830545191,"first_name":"Elena","last_name":"Nikulina","type":"private"},"date":1730663917,"text":"/start","entities":[{"offset":0,"length":6,"type":"bot_command"}]}}';
